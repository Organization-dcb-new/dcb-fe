...
import { calculateCodaTsel } from '../service/report/coda'
...
const ReportDownload: React.FC = () => {
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      setData(res.data)
      const parsed = calculateCodaTsel(res.data)
  ...
  const exportToPDF = () => {
    ...
    const docDefinitionNew: TDocumentDefinitions = {
      defaultStyle: {
        font: 'TimesNewRoman',
      },
      content: [
