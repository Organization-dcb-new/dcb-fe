...
import { template as CodaTelcoTemplate, CodaTelcoRow } from '../templates/pdf-report/coda/telco'
import type { ReportSummary, ReportData } from '../types/report'
...
const ReportDownload: React.FC = () => {
  ...
  const [tanData, setTanData] = useState<CodaTelcoRow[]>()
        ...
        data: {
          summaries: [
            ...
            },
            {
              ...
              amount_tax: 30000,
              count: 11015,
              total_amount: 330450000,
              total_amount_tax: 330450000,
              share_redision: 26436000,
              share_merchant: 304014000,
            },
            {
              user_id: '',
              merchant_name: 'HIGO GAME PTE LTD',
              ...
              amount_tax: 50000,
              count: 657,
              total_amount: 32850000,
              total_amount_tax: 32850000,
              share_redision: 2628000,
              share_merchant: 30222000,
            },
            {
              user_id: '',
              merchant_name: 'HIGO GAME PTE LTD',
              ...
              amount_tax: 60000,
              count: 912,
              total_amount: 54720000,
              total_amount_tax: 54720000,
              share_redision: 4377600,
              share_merchant: 50342400,
            },
            {
              user_id: '',
              merchant_name: 'HIGO GAME PTE LTD',
              ...
              amount_tax: 65000,
              count: 102,
              total_amount: 6630000,
              total_amount_tax: 6630000,
              share_redision: 530400,
              share_merchant: 6099600,
            },
            {
              user_id: '',
              merchant_name: 'HIGO GAME PTE LTD',
              ...
              amount_tax: 100000,
              count: 3794,
              total_amount: 379400000,
              total_amount_tax: 379400000,
              share_redision: 30352000,
              share_merchant: 349048000,
            },
            {
              user_id: '',
              merchant_name: 'HIGO GAME PTE LTD',
              ...
              amount_tax: 250000,
              count: 547,
              total_amount: 136750000,
              total_amount_tax: 136750000,
              share_redision: 10940000,
              share_merchant: 125810000,
            },
            {
              user_id: '',
              merchant_name: 'HIGO GAME PTE LTD',
              ...
              total_amount_tax: 65000000,
              share_redision: 5200000,
              share_merchant: 59800000,
            },
            {
              user_id: '',
              merchant_name: 'HIGO GAME PTE LTD',
              ...
              total_amount_tax: 68000000,
              share_redision: 5440000,
              share_merchant: 62560000,
            },
          ],
          additional_fee: 0,
          bhp_uso: 0,
          tax_23: 0,
          service_charge: 0,
          grand_total_redision: 131006000,
          total_merchant: 1506569000,
          grand_total: 1506569000,
          total_transaction_amount: 0,
          total_transaction: 89374,
          share_redision: 8,
          mdr: '0',
          share_merchant: 92,
        },
      }
      setFilteredApp('Codashop')
      setData(res.data)
      const parsed = res.data.summaries.map((item): CodaTelcoRow => {
        return {
          nilaiTransaksi: item.amount_tax,
          basicPrice: item.amount,
          diskonPenyedia: 0.22 * item.amount,
          codaSum: 0.78 * item.amount,
          jumlahTransaksi: item.count,
          payoutToCoda: 0.78 * item.amount * item.count,
        }
      })
                ...
                {footerGroup.headers.map((footer) => (
                  <td
                    ...
                    style={{
                      ...
                      padding: '8px',
                      // Rata tengah khusus kolom penanda label TOTAL PAYOUT
                      textAlign: footer.column.id === 'jumlahTransaksi' ? 'center' : 'right',
                    }}
                  >
